...
5. If the user wants the capability to persist across machines, promote it into the canonical `~/src/codex-skills` repo instead of leaving it as an unmanaged local extra.
...
If the user wants it to become part of their durable environment, add it to the canonical repo workflow instead of stopping at a local one-off install.
