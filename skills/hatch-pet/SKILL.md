---
name: hatch-pet
description: "Create, repair, validate, preview, and package Codex-compatible animated pet spritesheets from character art or generated images. Use to hatch a Codex pet or build a pet asset: 8x9 atlas, QA contact sheets, preview videos, pet.json packaging. Composes the installed $imagegen system skill and bundled assembly scripts."
---
